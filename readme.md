...
#### O que você precisa ter instalado em sua máquina ? só 2 coisas, são elas:

[3.1.1 - Docker](https://docs.docker.com/engine/install/)
[3.1.2 - Docker Compose](https://docs.docker.com/compose/install/)

### 3.2 - caso não tenha instalado em sua máquina os 2 itens acima, segue a documentação abaixo para instalar cada um.
